...
let package = Package(
    ...
    dependencies:[
        .package(url:"https://github.com/FernandoVGMonteiro/material-text-accessibility-ios", from: "2.0.0"),
        .package(url:"https://github.com/FernandoVGMonteiro/material-internationalization-ios", from: "2.0.0")
    ],
    targets: [
